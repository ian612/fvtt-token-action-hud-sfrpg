...
export const GROUP = {
    ...
    archetypeFeature:       { id: 'archetypeFeature',       name: 'Archetype Feature',          type: 'system' },
    classFeature:           { id: 'classFeature',           name: 'Class Feature',              type: 'system' },
    consumable:             { id: 'consumable',             name: 'Consumables',                type: 'system' },
    equipment:              { id: 'equipment',              name: 'Equipment',                  type: 'system' },
    feat:                   { id: 'feat',                   name: 'Feats',                      type: 'system'},
    feature:                { id: 'feature',                name: 'Features',                   type: 'system'},
    save:                   { id: 'save',                   name: 'Saves',                      type: 'system' },
    shield:                 { id: 'shield',                 name: 'Shields',                    type: 'system' },
    speciesFeature:         { id: 'speciesFeature',         name: 'Species Feature',            type: 'system' },
    ...
    themeFeature:           { id: 'themeFeature',           name: 'Theme Feature',              type: 'system' },
    token:                  { id: 'token',                  name: 'tokenActionHud.token',       type: 'system' },
    trained:                { id: 'trained',                name: 'Trained Skills',             type: 'system' },
    universalCreatureRule:  { id: 'universalCreatureRule',  name: 'Universal Creature Rule',    type: 'system' },
